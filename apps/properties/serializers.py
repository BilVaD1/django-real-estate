...
class PropertySerializer(serializers.ModelSerializer):
    ...
    country = CountryField(name_only=True) #  name_only=True, вы указываете, что в сериализованном выводе должно присутствовать только имя страны, а не объект страны целиком.
    ...
    class Meta:
        ...
        fields = [
            ...
            "published_status",
            "views",
        ] # поля которые возвращаются в ответе
